...
namespace GooglePlayGames.Editor
{
    ...
    public static class GPGSUtil
    {
        ...
        /// </summary>
        private const string GameInfoPath = "Assets/Third party/GooglePlayGames/GameInfo.cs";
        ...
        {
            return ReadFile(SlashesToPlatformSeparator("Assets/Third party/GooglePlayGames/Editor/" + name + ".txt"));
        }
